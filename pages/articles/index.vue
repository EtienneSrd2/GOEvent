<template>
  <div class="contener-blog">
    <header class="px-3 py-2 d-flex">
      <h2 class="text-uppercase pt-3 text-center flex-grow-1">ÉVÉNEMENTS</h2>
    </header>
    <main>
      <p class="text-white">Marcelle vous propose des événements qui pourraient vous intéresser</p>
